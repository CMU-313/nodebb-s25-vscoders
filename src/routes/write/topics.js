...
module.exports = function () {
  ...
  setupApiRoute(router, 'put', '/:tid/private', [...middlewares], controllers.write.topics.makePrivate)
  setupApiRoute(router, 'delete', '/:tid/private', [...middlewares], controllers.write.topics.makePublic)
